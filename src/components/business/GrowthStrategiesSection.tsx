...
const growthStrategies: StrategyCategory[] = [
  {
    id: "marketing",
    name: "Marketing",
    icon: Megaphone,
...
const GrowthStrategiesSection: React.FC = () => {
  ...
  return (
    <div className="mt-10">
      ...
      <Tabs defaultValue={growthStrategies[0].id} onValueChange={setActiveCategory} className="w-full">
        <TabsList className="w-full justify-start mb-6 overflow-x-auto flex-nowrap">
          {growthStrategies.map((category) => (
