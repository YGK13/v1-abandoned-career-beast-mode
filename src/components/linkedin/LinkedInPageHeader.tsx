...
interface LinkedInPageHeaderProps {
  title?: string;
  description?: string;
}

const LinkedInPageHeader: React.FC<LinkedInPageHeaderProps> = ({
  title = "LinkedIn Profile Optimization",
  description = "Improve your professional presence on the world's largest career network"
}) => {
  return (
...
export default LinkedInPageHeader;
